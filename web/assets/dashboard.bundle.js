...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WalletList = __webpack_require__(159);

	var _WalletList2 = _interopRequireDefault(_WalletList);
	...
	_reactDom2.default.render(_react2.default.createElement(_WalletList2.default, { url: '/api/wallets' }), walletList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Wallet = __webpack_require__(162);
	...
	var _class = function (_React$Component) {
	    ...
	    function _class(props) {
	        ...
	        _this.state = { wallets: [] };
	        _this.handleNewWallet = _this.handleNewWallet.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(_class, [{
	        ...
	        key: 'handleNewWallet',
	        value: function handleNewWallet(e) {
	            this.setState({ wallets: _jquery2.default.merge(this.state.wallets, [e]) });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var walletNodes = this.state.wallets.filter(function (wallet) {
	                return wallet.name !== '_world';
	            }).map(function (wallet) {
	                return _react2.default.createElement(_Wallet2.default, { key: wallet.id, id: wallet.id, owner: wallet.ours ? 'ours' : 'theirs', name: wallet.name, money: wallet.money.amount });
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TransactionList = __webpack_require__(163);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'h1',
	                        { className: 'wallet__name' },
	                        this.props.name
	                    ),
	                    _react2.default.createElement(
	                        'span',
	                        { className: moneyClassAttr },
	                        this.props.money
	                    )
	                ),
	                _react2.default.createElement(_TransactionList2.default, { walletId: this.props.id })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Transaction = __webpack_require__(164);
	    ...
	    _createClass(_class, [{
	        ...
	        value: function render() {
	            var transactionNodes = this.state.transactions.slice(0, 5).map(function (transaction) {
	                ...
	                return _react2.default.createElement(_Transaction2.default, { key: transaction.id, isDebit: isDebit, money: transaction.money.amount, description: transaction.description });
	            }.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./badge.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./badge.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_React$Component) {
	    ...
	    function _class(props) {
	        ...
	        _this.state = { description: '', owner: false };
	    ...
	    _createClass(_class, [{
	        ...
	        value: function handleOwnerChange(e) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        null,
	                        _react2.default.createElement('input', { type: 'checkbox', onChange: this.handleOwnerChange }),
	                        ' Is this yours?'
	                    ),
	                    _react2.default.createElement('input', { type: 'submit', value: 'Create', className: 'action-button action-button--wallet' })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./action-button.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./action-button.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./wallet.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./wallet.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./generic.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./generic.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
